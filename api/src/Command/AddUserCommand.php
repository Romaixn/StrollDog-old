...
class AddUserCommand extends Command
{
    ...
    protected function interact(InputInterface $input, OutputInterface $output): void
    {
        ...
        if (null !== $name) {
            $this->io->text(' > <info>Full Name</info>: '.$name);
        } else {
            $name = $this->io->ask('Full Name', null);
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $this->validateUserData($username, $email);
    ...
    private function validateUserData(?string $username, ?string $email): void
    {
