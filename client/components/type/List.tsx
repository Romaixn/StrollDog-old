      ...
      <div className="sm:flex sm:items-center">
        ...
        <div className="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
          <Link href="/admin/types/create">
            <a className="inline-flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:w-auto">Créer un type</a>
          </Link>
        </div>
      </div>
                    ...
                    <tr key={type["@id"]} className={selectedType.includes(type) ? 'bg-gray-50' : undefined}>
                      ...
                      <td
                        className={classNames(
                          ...
                          selectedType.includes(type) ? 'text-indigo-600' : 'text-gray-900'
                        )}
                      >
                        {type['name']}
                      </td>
