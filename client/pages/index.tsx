...
const Home: NextPage = () => {
  ...
  return (
    <>
      <Meta title="Accueil" description="StrollDog est un site web qui vous permet de trouver les meilleurs endroits pour promener votre chien dans votre région." />
      <Layout>
